...
const nodes: Node[] = [
  ...
  { id: "historian", position: { x: 560, y: 440 }, data: { label: "Historian\n.40" }, style: nodeStyle("#f97316") },
  { id: "gps", position: { x: 560, y: 540 }, data: { label: "GPS Clock\n.50" }, style: nodeStyle("#f97316") },
  ...
  { id: "capbank", position: { x: 840, y: 440 }, data: { label: "Cap Bank\n.23" }, style: nodeStyle("#22c55e") },
...
const edges: Edge[] = [
  ...
  { id: "rtac-capbank", source: "rtac", target: "capbank", animated: true, style: { stroke: "#22c55e", strokeWidth: 2 } },
];
...
export function TopologyPreview() {
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-950" style={{ height: 600 }}>
      <ReactFlow
        nodes={nodes}
        edges={edges}
        fitView
