...
var NodeCatalog = []NodeTemplate{
	...
	{Type: "ews", Name: "Engineering Workstation", Description: "Ubuntu-based desktop with noVNC and OpenPLC IDE", DefaultNetworks: []string{"it_net"}, Image: "linuxserver/webtop:ubuntu-mate"},
	{Type: "jump_host", Name: "Pentest Jump Host", Description: "Kali-lite tooling for trainees", DefaultNetworks: []string{"it_net"}, Image: "kalilinux/kali-rolling", Cmd: []string{"sleep", "infinity"}},
	...
	{Type: "ot_ids", Name: "OT IDS", Description: "Suricata sensor with ICS signatures", DefaultNetworks: []string{"dmz"}, Image: "jasonish/suricata:latest", Cmd: []string{"suricata", "-c", "/etc/suricata/suricata.yaml", "-i", "eth0"}},
